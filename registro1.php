...
if(mysqli_connect_error()){
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$ano=mysqli_real_escape_string($connect, $_POST['ano_exp']);
		$sexo=mysqli_real_escape_string($connect, $_POST['genero']);
		$cant_cvv=strlen($cvv);

		if(isset($nombre)&&isset($password)&&isset($confirm_pass)&&isset($correo)&&isset($confirm_correo)&&isset($telefono)&&isset($tar1)&&isset($tar2)&&isset($tar3)&&isset($tar4)&&isset($cvv)&&isset($mes)&&isset($ano)&&$sexo!='null'){
